package com.jax_rs_streaming.repository;
...
public class CustomerEventRepositoryAsync {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerEventRepositoryAsync.class);

    private Session session;

    private PreparedStatement getEventsForCustomer;

    public CustomerEventRepositoryAsync(Session session) {
